...
import elipse1 from "../assets/Ellipse 63.png";
  ...
  render() {
    return (
      <>
        <div className="container">
          <div className="about-hero">
            ...
            <p className="about-details">
              Arms4AI is a 100% Indian Startup venture based in New Delhi. We
              specialize in building tailored AI based Geospatial solutions by
              leveraging multi-disciplinary Geospatial Technologies to develop
              cutting-edge solutions, designed for strategic impact, decision
              and intelligence and to strengthen national security.
            </p>
          </div>
          <div className="about-ani">
            <h1>
              GEO-AI Innovator, Transforming Data into Informed Decisions Across
              Industries in One Click
            </h1>
          </div>
        </div>
        <div className="white-ball-holder">
          <div className="white-ball">
            <div className="elipse3-about">
              <img src={elipse1} alt="" />
            </div>
        ...
        <div className="container" style={{ backgroundColor: "white" }}>
          <div className="about-mission">
            <div className="about-slider active" id="mission1">
              <h3>
                Join us on our Mission to transform the world with bold ideas
                and Innovation
              </h3>
              <p> </p>
            </div>
            <div className="about-slider" id="mission2">
              <h3>
                Join us on our <font>Mission</font> to transform the world with
          ...
          <div className="container">
            <div className="blue-flex">
              <div className="blue-left">
                <h3>MEET THE TEAM</h3>
                <h1>A dream team of experts who make it happen every day.</h1>
              </div>
              <div className="blue-right">
                <p>
                  Our team has a blend of vast experience starting from
                  strategic planning and operations, over 20 years of domain
                  expertise in geospatial technology, capabilities to build
                  cutting edge technology driven tools, and an ability to sell
                  at the right place and at the right moment. We have a perfect
                  amalgamation of experience, freshness and wisdom to establish
                  our names in the industry.
                  <br />
                  <br />
                  The combination of our team, domain expertise, idea
                  conceptualisation, current market worth, business traction,
                  network within India and abroad and most importantly wisdom to
                  apply this technology in image analysis and produce new
        ...
        <div
          className="container"
          style={{ backgroundColor: "white", paddingTop: "300px" }}
        >
            ...
            <div className="team-card-list-holder">
              <div className="team-card">
                <div className="team-card-img">
                  <img src={jagriti} alt="Jagriti" style={{width:242.5, borderRadius: 13, paddingTop:60, paddingLeft: 4}}></img>
                </div>
                <h6>
              ...
              <div className="team-card">
                <div className="team-card-img">
                <img src={siddham} alt="Siddham" style={{width:243.5, borderRadius: 15, paddingTop:66, paddingLeft:4 }}></img>
                </div>
                <h6>
              ...
              <div className="team-card">
                <div className="team-card-img">
                <img src={himanshu} alt="Himanshu" style={{width:250, borderRadius: 24, paddingTop:15.5}}></img>
                </div>
                <h6>
                ...
                <div className="card-line"></div>
                <div className="card-footer">
                  <p>Technology Partnership Manager</p>
                  <div>
                    <img src={twiter} alt="" />
                    <img src={linkedn} alt="" />
                  </div>
        ...
        <div className="about-blue">
          <div className="container">
            ...
            <p>
              ...
              conceptualisation, current market worth, business traction,
              network within India and abroad and most importantly wisdom to
              apply this technology in image analysis and produce new innovative
              solutions give us an edge to get in this venture.
            </p>
            <div className="blue-items">
              <div className="blue-item">
                <div></div>
                <font className="blue-item-name">CAAS</font>
                <font className="blue-item-subname">
                  Capability as a Service
                </font>
                <font className="blue-item-detail">
                  Customised stand-alone desktop-based tool, for enterprise
                  industry offering an end to end solution for data preparation
                  and geospatial image analysis with advanced analytics.
                </font>
              </div>
              <div className="blue-item">
                <div></div>
                <font className="blue-item-name">DAAS</font>
                <font className="blue-item-subname">Data as a Service</font>
                <font className="blue-item-detail">
                  Customers who require bulk data products in no time and wish
                  to procure data products directly.
                </font>
              </div>
              <div className="blue-item">
                <div></div>
                <font className="blue-item-name">SAAS</font>
                <font className="blue-item-subname">
                  Subscription as a Service
                </font>
                <font className="blue-item-detail">
                  Online platform based on subscription as per the user
                  requirement that will offer number of AI based image
                  processing tools.
                </font>
              </div>
            </div>
        ...
        <div className="container">
          <div className="about-focus">
            <div className="about-focus-left">
              <h3>We focus on building solutions</h3>
              <p>
                The combination of our team, domain expertise, idea
                conceptualisation, current market worth, business traction,
                network within India and abroad and most importantly wisdom to
            ...
            <div className="about-focus-right">
              <div className="focus-list">
                <div></div>
                <h6>High Effiiciency and Productivity</h6>
              </div>
              <div className="focus-list">
                <div></div>
                <h6>Infrastructure and high Resource Economy</h6>
              </div>
              <div className="focus-list">
                <div></div>
              ...
              <div className="focus-list">
                <div></div>
                <h6>Better Utilization of Data</h6>
              </div>
              <div className="focus-list">
                <div></div>
